...
const travelOptions = [
  ...
  {
    type: 'bus',
    busOperator: 'சிங் பஸ் பிளஸ் (zingbus plus)',
    busType: 'ac',
    source: 'MAS', sourceName: 'சென்னை',
    destination: 'CBE', destinationName: 'கோவை',
    departureTime: '20:30', arrivalTime: '07:00',
    duration: '10h 30m', durationMinutes: 630,
    days: ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'],
    pricing: [ { class: 'AC Semi Sleeper', price: 928, totalSeats: 30, availableSeats: 11 } ],
    foodService: { available: false },
    luggageAllowance: 20,
  },
  ...
  },
  {
    ...
    source: 'MAS', sourceName: 'சென்னை',
    destination: 'CBE', destinationName: 'கோவை',
    departureTime: '22:30', arrivalTime: '08:00',
    duration: '9h 30m', durationMinutes: 570,
    days: ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'],
    pricing: [ { class: 'AC Sleeper', price: 986, totalSeats: 30, availableSeats: 16 } ],
    foodService: { available: false },
    luggageAllowance: 20,
  },
  ...
  {
    type: 'bus',
    busOperator: 'இன்டர்சிட்டி ஸ்மார்ட் பஸ் (IntrCity SmartBus)',
    busType: 'ac',
    source: 'MAS', sourceName: 'சென்னை',
    destination: 'MDU', destinationName: 'மதுரை',
    departureTime: '22:00', arrivalTime: '07:00',
    duration: '9h 0m', durationMinutes: 540,
    days: ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'],
    pricing: [ { class: 'AC Seater', price: 1500, totalSeats: 30, availableSeats: 7 } ],
    foodService: { available: false },
    luggageAllowance: 25,
  },
  {
    type: 'bus',
    busOperator: 'ஃபிளிக்ஸ்பஸ் (FlixBus)',
    busType: 'sleeper',
    source: 'MAS', sourceName: 'சென்னை',
    destination: 'MDU', destinationName: 'மதுரை',
    departureTime: '20:00', arrivalTime: '05:40',
    duration: '9h 40m', durationMinutes: 580,
    days: ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'],
    pricing: [ { class: 'AC Sleeper', price: 539, totalSeats: 30, availableSeats: 11 } ],
    foodService: { available: false },
    luggageAllowance: 20,
  },
  ...
  // --- Buses (Madurai → Chennai) ---
  {
    ...
    source: 'MDU', sourceName: 'மதுரை',
    destination: 'MAS', destinationName: 'சென்னை',
    departureTime: '22:15', arrivalTime: '06:30',
    duration: '8h 15m', durationMinutes: 495,
    days: ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'],
    pricing: [ { class: 'AC Semi Sleeper', price: 990, totalSeats: 30, availableSeats: 9 } ],
    foodService: { available: false },
    luggageAllowance: 20,
  },
  {
    ...
    source: 'MDU', sourceName: 'மதுரை',
    destination: 'MAS', destinationName: 'சென்னை',
    departureTime: '23:45', arrivalTime: '07:35',
    duration: '7h 50m', durationMinutes: 470,
    days: ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'],
    pricing: [ { class: 'AC Sleeper', price: 998, totalSeats: 30, availableSeats: 18 } ],
    foodService: { available: false },
    luggageAllowance: 25,
  },
  ...
  // --- Buses (Tirunelveli → Trichy) ---
  {
    ...
    source: 'TEN', sourceName: 'திருநெல்வேலி',
    destination: 'TPJ', destinationName: 'திருச்சி',
    departureTime: '20:00', arrivalTime: '04:45',
    duration: '8h 45m', durationMinutes: 525,
    days: ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'],
    pricing: [ { class: 'AC Sleeper', price: 1399, totalSeats: 30, availableSeats: 3 } ],
    foodService: { available: false },
    luggageAllowance: 20,
  },
  {
  ...
  // ===========================================================================
  // HYDERABAD (HYB/SC) ⇄ DELHI (NDLS)
  // ===========================================================================
  {
    type: 'train',
    trainNumber: '12723',
    trainName: 'தெலுங்கானா எக்ஸ்பிரஸ் (Telangana Exp)',
    source: 'HYB', sourceName: 'ஹைதராபாத்',
    destination: 'NDLS', destinationName: 'புது டெல்லி',
    departureTime: '06:00', arrivalTime: '09:05',
    duration: '27h 5m', durationMinutes: 1625,
    days: ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'],
    pricing: [
      { class: 'SL', price: 780, totalSeats: 72, availableSeats: 12 },
      { class: '3A', price: 2100, totalSeats: 64, availableSeats: 8 },
      { class: '2A', price: 3100, totalSeats: 48, availableSeats: 4 }
    ],
    foodService: { available: true },
    luggageAllowance: 40,
  },
  {
    type: 'flight',
    flightNumber: '6E-2433',
    airline: 'IndiGo',
    source: 'HYB', sourceName: 'ஹைதராபாத்',
    destination: 'DEL', destinationName: 'டெல்லி',
    departureTime: '10:30', arrivalTime: '12:45',
    duration: '2h 15m', durationMinutes: 135,
    days: ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'],
    pricing: [ { class: 'Economy', price: 4800, totalSeats: 180, availableSeats: 40 } ],
    foodService: { available: true },
    luggageAllowance: 15,
  },

  // ===========================================================================
  // BANGALORE (SBC/YPR) ⇄ HYDERABAD (HYB/KCG)
  // ===========================================================================
  {
    type: 'train',
    trainNumber: '12786',
    trainName: 'காச்சிகுடா எக்ஸ்பிரஸ் (Kachiguda Exp)',
    source: 'SBC', sourceName: 'பெங்களூரு',
    destination: 'HYB', destinationName: 'ஹைதராபாத்',
    departureTime: '18:20', arrivalTime: '05:40',
    duration: '11h 20m', durationMinutes: 680,
    days: ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'],
    pricing: [
      { class: 'SL', price: 420, totalSeats: 72, availableSeats: 25 },
      { class: '3A', price: 1100, totalSeats: 64, availableSeats: 12 }
    ],
    foodService: { available: false },
    luggageAllowance: 25,
  },
  {
    type: 'bus',
    busOperator: 'ஆரஞ்சு டிராவல்ஸ் (Orange Travels)',
    busType: 'sleeper',
    source: 'SBC', sourceName: 'பெங்களூரு',
    destination: 'HYB', destinationName: 'ஹைதராபாத்',
    ...
    duration: '9h 30m', durationMinutes: 570,
    days: ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'],
    pricing: [ { class: 'AC Sleeper', price: 1450, totalSeats: 30, availableSeats: 10 } ],
    foodService: { available: false },
    luggageAllowance: 20,
  },
  ...
  // ===========================================================================
  {
    type: 'train',
    trainNumber: '12842',
    trainName: 'கோரமண்டல் எக்ஸ்பிரஸ் (Coromandel Exp)',
    source: 'MAS', sourceName: 'சென்னை',
    destination: 'HWH', destinationName: 'கொல்கத்தா',
    departureTime: '07:00', arrivalTime: '10:40',
    duration: '27h 40m', durationMinutes: 1660,
    days: ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'],
    pricing: [
      { class: 'SL', price: 740, totalSeats: 72, availableSeats: 5 },
      { class: '3A', price: 1950, totalSeats: 64, availableSeats: 3 }
    ],
    foodService: { available: true },
    luggageAllowance: 40,
  },
  ...
  // ===========================================================================
  // CHENNAI (MAS) ⇄ MUMBAI (CSMT)
  // ===========================================================================
  {
    type: 'train',
    trainNumber: '12164',
    trainName: 'சென்னை - மும்பை எக்ஸ்பிரஸ்',
    source: 'MAS', sourceName: 'சென்னை',
    destination: 'BOM', destinationName: 'மும்பை',
    departureTime: '06:20', arrivalTime: '05:40',
    duration: '23h 20m', durationMinutes: 1400,
    days: ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'],
    pricing: [
      { class: 'SL', price: 650, totalSeats: 72, availableSeats: 18 },
      { class: '3A', price: 1750, totalSeats: 64, availableSeats: 10 }
    ],
    foodService: { available: true },
    luggageAllowance: 40,
  },
  ...
  // ===========================================================================
  // SALEM (SA) ⇄ CHENNAI (MAS/MS)
  // ===========================================================================
  {
    type: 'train',
    trainNumber: '22154',
    trainName: 'சேலம் எக்ஸ்பிரஸ் (Salem Exp)',
    source: 'SA', sourceName: 'சேலம்',
    destination: 'MS', destinationName: 'சென்னை',
    departureTime: '21:30', arrivalTime: '03:45',
    duration: '6h 15m', durationMinutes: 375,
    days: ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'],
    pricing: [
      { class: 'SL', price: 245, totalSeats: 72, availableSeats: 40 },
      { class: '3A', price: 650, totalSeats: 64, availableSeats: 25 }
    ],
    foodService: { available: false },
    luggageAllowance: 25,
  },
  {
    ...
    source: 'SA', sourceName: 'சேலம்',
    destination: 'MAS', destinationName: 'சென்னை',
    departureTime: '23:15', arrivalTime: '06:00',
    duration: '6h 45m', durationMinutes: 405,
    days: ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'],
    pricing: [ { class: 'AC Semi Sleeper', price: 849, totalSeats: 30, availableSeats: 15 } ],
    foodService: { available: false },
    luggageAllowance: 20,
  },
  // ===========================================================================
  // ZINGBUS PLUS & INTRCITY ON ALL MAJOR ROUTES (User Requested)
  // ===========================================================================
  {
    type: 'bus',
    busOperator: 'சிங் பஸ் பிளஸ் (zingbus plus)',
    ...
    source: 'HYB', sourceName: 'ஹைதராபாத்',
    destination: 'NDLS', destinationName: 'புது டெல்லி',
    departureTime: '18:00', arrivalTime: '21:00', // Multi-day
    duration: '27h 0m', durationMinutes: 1620,
    days: ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'],
    pricing: [ { class: 'AC Sleeper', price: 2800, totalSeats: 30, availableSeats: 10 } ],
    foodService: { available: true },
    luggageAllowance: 30,
  },
  {
    ...
    source: 'SBC', sourceName: 'பெங்களூரு',
    destination: 'HYB', destinationName: 'ஹைதராபாத்',
    departureTime: '22:30', arrivalTime: '07:00',
    duration: '8h 30m', durationMinutes: 510,
    days: ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'],
    pricing: [ { class: 'AC Seater', price: 1250, totalSeats: 30, availableSeats: 12 } ],
    foodService: { available: false },
    luggageAllowance: 20,
  },
  {
    ...
    busOperator: 'ஃபிளிக்ஸ்பஸ் (FlixBus)',
    busType: 'sleeper',
    source: 'BOM', sourceName: 'மும்பை',
    destination: 'MAS', destinationName: 'சென்னை',
    departureTime: '14:00', arrivalTime: '16:00', // Multi-day
    duration: '26h 0m', durationMinutes: 1560,
    days: ['Mon', 'Wed', 'Fri', 'Sun'],
    pricing: [ { class: 'AC Sleeper', price: 3200, totalSeats: 30, availableSeats: 8 } ],
    foodService: { available: true },
    luggageAllowance: 25,
  },
  {
    ...
    source: 'MAS', sourceName: 'சென்னை',
    destination: 'HWH', destinationName: 'கொல்கத்தா',
    departureTime: '06:00', arrivalTime: '18:00', // Multi-day
    duration: '36h 0m', durationMinutes: 2160,
    days: ['Tue', 'Thu', 'Sat'],
    pricing: [ { class: 'AC Semi Sleeper', price: 3500, totalSeats: 30, availableSeats: 5 } ],
    foodService: { available: true },
    luggageAllowance: 30,
  },
  {
    ...
    busOperator: 'சிங் பஸ் பிளஸ் (zingbus plus)',
    busType: 'sleeper',
    source: 'NDLS', sourceName: 'புது டெல்லி',
    destination: 'HYB', destinationName: 'ஹைதராபாத்',
    departureTime: '15:30', arrivalTime: '18:45',
    duration: '27h 15m', durationMinutes: 1635,
    days: ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'],
    pricing: [ { class: 'AC Sleeper', price: 2950, totalSeats: 30, availableSeats: 12 } ],
    foodService: { available: true },
    luggageAllowance: 30,
  },
  {
    ...
    busType: 'ac',
    source: 'HYB', sourceName: 'ஹைதராபாத்',
    destination: 'SBC', destinationName: 'பெங்களூரு',
    departureTime: '21:00', arrivalTime: '06:30',
    duration: '9h 30m', durationMinutes: 570,
    days: ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'],
    pricing: [ { class: 'AC Semi Sleeper', price: 1100, totalSeats: 30, availableSeats: 10 } ],
    foodService: { available: false },
    luggageAllowance: 20,
  },
];
